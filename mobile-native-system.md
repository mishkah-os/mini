MishkahDesignSystem({
  ...
  components: {
    AppShell: {
      ...
      accessibility: { ariaLabel: 'shellLabelKey' }
    },
    TopBar: {
    ...
    SearchBar: {
      ...
      accessibility: { labelKey: 'searchLabelKey' }
    },
    ...
    TextField: {
      ...
      accessibility: { labelKey: 'fieldLabelKey' }
    },
    TextArea: {
      props: { value: 'string', labelKey: 'i18nKey', helperKey: 'i18nKey' },
      slots: {},
  ...
  nativeFeelChecklist: [
    'Typography hierarchy uses mobile scale (11-24) with balanced line heights.',
    'Spacing follows 8pt grid with 16/24 default paddings.',
    'Only primary actions use ButtonPrimary; list items use subtle affordance.',
    'Cards are neutral surfaces without implicit clickability.',
    'Elevation uses flat/raised/modal only.',
    'Safe areas are respected for top/bottom bars and sheets.',
    'Skeleton, empty, and error states are included per template.',
    'RTL mirroring is supported for padding, alignment, and disclosure.'
  ]
});
